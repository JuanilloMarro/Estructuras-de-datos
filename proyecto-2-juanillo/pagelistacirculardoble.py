...
class PageListaCircularDoble():
	def __init__(self):
		self.top = Toplevel()

		self.top.title('Lista Circular Doble')
		...
		# --- Visualización gráfica de la Lista Circular Doble ---

		# Frame principal donde se encuentra el frame del título y el frame de la construcción de la Lista Circular Doble
		self.frame_all_lista_circular_doble = Frame(self.top)
		self.frame_all_lista_circular_doble.config(width= 650, height=600, bg='white')
		self.frame_all_lista_circular_doble.pack(side='left', fill="both", expand=True)

		# Frame del título y su respectivo label
		self.frame_titulo_lista_circular_doble = Frame(self.frame_all_lista_circular_doble)
		self.frame_titulo_lista_circular_doble.config(bg='white', width= 650, height=150)
		self.frame_titulo_lista_circular_doble.pack(fill="both", expand=True, padx=100, pady=50)
		self.label_titulo_lista_circular_doble = Label(self.frame_titulo_lista_circular_doble)
		self.label_titulo_lista_circular_doble.config(font=self.fuente, text='Visualización de la Lista Circular Doble', bg='white')
		self.label_titulo_lista_circular_doble.pack()

		# Frame de la construcción de la Lista Circular Doble
		self.frame_lista_circular_doble = Frame(self.frame_all_lista_circular_doble)
		self.frame_lista_circular_doble.config(bg='white', width= 650, height=450)
		self.frame_lista_circular_doble.pack(fill="both", expand=True)

		# Frames que contienen los números que existen dentro de la Lista Circular Doble y su respectivo label
		self.frame_content = Frame(self.frame_lista_circular_doble)
		...
		# --- Información de la Lista Circular Doble ---

		# Frame principal donde se encuentra toda la información de la Lista Circular Doble
		self.frame_info_lista_circular_doble = Frame(self.top)
		self.frame_info_lista_circular_doble.config(bg='#C8EDC8', width=350, height=750)
		self.frame_info_lista_circular_doble.pack(side='right', fill='both')

		# Frame que contiene el título 'Información de la Lista Circular Doble' y todos los frames correspondientes a él
		self.info_especifica_lista_circular_doble = Frame(self.frame_info_lista_circular_doble)
		self.info_especifica_lista_circular_doble.config(bg='#C8EDC8')
		self.info_especifica_lista_circular_doble.pack(pady=15, padx=5)
		self.label_title_info_lista_circular_doble = Label(self.info_especifica_lista_circular_doble,
														   text='Información de la Lista Circular',
														   bg='#C8EDC8',
														   font=self.fuente)
		self.label_title_info_lista_circular_doble.pack()

		# Frame que contiene dos labels: el tamaño y el otro label donde se asigna el tamaño
		self.frame_tamano = Frame(self.info_especifica_lista_circular_doble)
		...
		self.frame_tope = Frame(self.info_especifica_lista_circular_doble)
		...
		self.frame_fondo = Frame(self.info_especifica_lista_circular_doble)
		...
		self.opciones_valor = Frame(self.frame_info_lista_circular_doble)
		...
		self.frame_archivos = Frame(self.frame_info_lista_circular_doble)
	...
	def guardar_en_json(self):
		...
		with open("json/lista_circular_doble.json", "w") as f:
	...
	def actualizar_lista(self):
		...
		with open("json/lista_circular_doble.json", "r") as f:
	...
	def render(self, datos):
		...
		self.frame_lista_circular_doble.destroy()

		self.frame_lista_circular_doble = Frame(self.frame_all_lista_circular_doble)
		self.frame_lista_circular_doble.config(bg='white')
		self.frame_lista_circular_doble.pack(side='left', pady=200)
	...
	def rotate_left(self):
		...
		self.actualizar_lista_circular_doble()
	...
	def actualizar_lista_circular_doble(self):
